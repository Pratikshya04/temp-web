...
<link rel="stylesheet" href="https://cdn.datatables.net/1.10.25/css/jquery.dataTables.min.css">
    ...
    <title>Gro-Fresh - Delete Seller</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="Admin.php">
                ...
                <div class="sidebar-brand-text mx-3">Gro-Fresh </div>
            </a>
           ...
           <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="delseller.php">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>Gro-Fresh Admin Pro</strong> is packed with premium features, components, and more!</p>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar --> <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Shailendra</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-hero bg-image overlay-dark" style="background-image: url(assets/images/del.jpg); background-repeat:no-repeat;background-size:cover;height:20%">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
          <br>
        <span class="subhead" style='color:black'>Let's make it easy</span><br>
        <span class="display-4" style="height:1em;color:black">Remove Seller</span>
        <br>
        <br>
        <a href="#" class="btn "></a>
      </div>
         ...
         $s=mysqli_query($con,"select * from seller");
	              ...
	              while($row=mysqli_fetch_array($s))
                 {
                    ...
                    echo "<td align='center'>$sno</td>";
                         ...
                         echo "<td align='center'>$row[8],$row[9],$row[10],$row[11]</td>";
